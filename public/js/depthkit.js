(function e(t, n, r) {
  ...
  })(
    {
      ...
      2: [
        function(require, module, exports) {
          ...
          //For building the geomtery oirig 256 each
          var VERTS_WIDE = 512;
          var VERTS_TALL = 512;
  ...
  //                 principleX: {
  //                   type: "f",
  //                   value: properties.depthPrincipalPoint.x
  //                 },
  //                 principleY: {
  //                   type: "f",
  //                   value: properties.depthPrincipalPoint.y
  //                 }
  //               },
  ...
  //             this.add(
  //               new THREE.Line(linesGeometry, linesMaterial, THREE.LinePieces)
  //             );
              ...
              this.jsonLoader.load(
                ...
                function(data) {
                  ...
                  _this.material.uniforms.height.value =
                    _this.props.textureHeight;
                  _this.material.uniforms.mindepth.value = _this.props.nearClip;
                  _this.material.uniforms.maxdepth.value = _this.props.farClip;
                  _this.material.uniforms.focalLength.value =
                    _this.props.depthFocalLength;
                  _this.material.uniforms.principalPoint.value =
                    _this.props.depthPrincipalPoint;
                  _this.material.uniforms.imageDimensions.value =
                    _this.props.depthImageSize;
                  _this.material.uniforms.crop.value = _this.props.crop;

                  var ex = _this.props.extrinsics;
                  _this.material.uniforms.extrinsics.value.set(
                    ex["e00"],
                    ex["e10"],
                    ex["e20"],
                    ex["e30"],
                 ...
                 var boxGeo = new THREE.BoxGeometry(
                    _this.props.boundsSize.x,
                    _this.props.boundsSize.y,
                  //  _this.props.boundsSize.z
                  );
              ...
              [
                {
                  ...
                  value: function setPointSize(size) {
                    if (this.material.uniforms.isPoints.value) {
                      ...
                      console.warn(
                        "Can not set point size because the current character is not set to render points"
                      );
                    }
                  }
                },
                ...
                },
                {
                  ...
                  value: function setLineWidth(width) {
                    if (this.material.wireframe) {
                      ...
                      console.warn(
                        "Can not set the line width because the current character is not set to render wireframe"
                      );
                    }
                  }
                ...
                },
                {
                  ...
                  value: function play() {
                    if (!this.video.isPlaying) {
                      ...
                      console.warn(
                        "Can not play because the character is already playing"
                      );
                    }
                  }
                },
      ...
      3: [
        function(require, module, exports) {
          ...
          if (
            ...
            _typeof(window.THREE) === "object"
          ) {
            window.DepthKit = _depthkit2.default;
          } else {
            console.warn(
              "[DepthKit.js] It seems like THREE is not included in your code, try including it before DepthKit.js"
            );
          }
